...
const CreateCategory = () => {
    ...
    const handleSubmit = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.post(`api/v1/category/create-category`, { name: newCategory });
            if (res.data.success) {
                if (newCategory !== "")
    ...
    const handleUpdateCategory = async (e) => {
        e.preventDefault();
        try {
            const res = await axios.put(`api/v1/category/update-category/${selectCategory._id}`, { name: updatedCategory });
            if (res.data.success) {
