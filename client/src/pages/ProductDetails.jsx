...
const ProductDetails = () => {
    ...
    const getProduct = async () => {
        try {
            ...
            // setImgSrc(`https://ecommerce-app-5dgy.onrender.com:5000/api/v1/product/product-photo/${product?._id}`)
    ...
    const getSimilarProducts = async (pid, cid) => {
        try {
            const { data } = await axios.get(`https://ecommerce-app-5dgy.onrender.com:5000/api/v1/product/similar-products/${pid}/${cid}`);
        ...
        <div>
            <div className="row container mt-2">
                <div className="col-md-6">
                    <img src={`https://ecommerce-app-5dgy.onrender.com:5000/api/v1/product/product-photo/${product._id}`} className="card-img-top" alt={product.name} height="300" width={"350px"} />
                </div>
                <div className="col-md-6">
