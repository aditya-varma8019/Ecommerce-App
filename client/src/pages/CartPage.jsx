...
const CartPage = () => {
    ...
    const getToken = async () => {
        try {
            const { data } = await axios.get(`https://ecommerce-app-5dgy.onrender.com:5000/api/v1/product/braintree/token`)
    ...
    const handlePayment = async () => {
        try {
            ...
            const { data } = await axios.post(`https://ecommerce-app-5dgy.onrender.com:5000/api/v1/product/braintree/payment`, {
                nonce,
                cart
            })
            setLoading(false);
